...
namespace CUDAFingerprinting.ImageProcessing.Triangulation
{
    public static class DelaunayTriangulation
    {
        public static List<Triangle> CreateDelaunayTriangulation(List<Point> points)
        {
        ...
        private class PolarPoint : IComparable<PolarPoint>
        {
            private Point pole;
